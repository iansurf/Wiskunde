...
\begin{tikzpicture}[scale=4, line cap=round, line join=round, >=stealth]
  ...
  \pic[draw,"$\alpha$",angle radius=6mm,angle eccentricity=1.2]
      {angle=X--O--P};
  \pic[draw,labg,"$90^\circ-\alpha$",angle radius=10mm,angle eccentricity=1.2]
      {angle=X--O--P90m};
  \pic[draw,labg,"$90^\circ+\alpha$",angle radius=14mm,angle eccentricity=1.2]
      {angle=X--O--P90p};
  \pic[draw,labg,"$180^\circ-\alpha$",angle radius=18mm,angle eccentricity=2]
      {angle=X--O--P180m};
  \pic[draw,labg,"$180^\circ+\alpha$",angle radius=22mm,angle eccentricity=1.23]
      {angle=X--O--P180p};
  \pic[draw,labg,"$-\alpha$",angle radius=26mm,angle eccentricity=1.15]
      {angle=Pneg--O--X};

  % outside captions
  \node[labg,anchor=east]  at (P180m) {supplementair $\alpha$};
  \node[labg,anchor=east]  at (P180p) {antisupplementair $\alpha$};
  \node[labg,anchor=west]  at (Pneg) {tegengestelde $\alpha$};
  \node[labg,anchor=east] at (P90p) {anticomplementair $\alpha$};
  \node[labg,anchor=west]  at (P90m) {complementair $\alpha$};

  % sin & cos for α
  \coordinate (U) at (\cx,\sx);
  \draw[sincos,<->] (O) -- (\cx,0) node[midway,below=2pt] {\small $\cos\alpha$};
