...
% ----------------- Second row (copy) -----------------
\node (box3) [draw, inner sep=2pt, minimum width=5cm, below=1cm of box1] {
...
\node (box4) [draw, inner sep=2pt, minimum width=5cm, below=1cm of box2] {
  \begin{minipage}{0.4\linewidth}
  \[
  \begin{array}{c}
  \begin{bmatrix}
...
% ----------------- row 3 -----------------
\node (box5) [draw, inner sep=2pt, minimum width=5cm, below=1cm of box3] {
  \begin{minipage}{0.4\linewidth}
  \[
  \begin{array}{c}
  \begin{bmatrix}
...
\node (box6) [draw, inner sep=2pt, minimum width=5cm, below=1cm of box4] {
 \begin{minipage}{0.4\linewidth}
  \[
  \begin{array}{c}
  \begin{bmatrix}
