...
\(\begin{aligned}
E[X] &= \mu_X = \sum_{i=1}^{n} X_i\!\cdot\!p_i \\[2pt]
\sigma_X^2 &= \sum_{i=1}^{n} (x_i - \mu_X)^2\!\cdot\!p_i=\left(\sum_{i=1}^{n} x_i^2\!\cdot\!p_i \right) - \mu_X^2
\end{aligned}\) &
\(\begin{aligned}
E[X] &= \mu_X = \int_a^b x\!\cdot\!f(x)\,dx \\[2pt]
\sigma_X^2 &= \int_a^b (x - \mu_X)^2\!\cdot\!f(x)\,dx=\int_a^b x^2\!\cdot\!f(x)\,dx - \mu_X^2
\end{aligned}\) \\[4pt]
\hline
\end{tabular}
\normalsize
