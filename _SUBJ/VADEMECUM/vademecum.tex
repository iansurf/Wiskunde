...
\end{center}
% % ----------------------------------------------------------------------------- 
% --- Determinanten (compact, fits on page) ------------------------------------
...
\node (box1) [draw, inner sep=2pt, minimum width=10cm] at (0,0) {%
  ...
  % smaller intercolumn space than \qquad
  \[
  \setlength{\arraycolsep}{4pt}%
  \begin{array}{c @{\hspace{6pt}} c}
    {\displaystyle
    ...
    {\displaystyle
      ...
      % ---- ultra-compact inline mini-TikZ ----
      \tikz[scale=0.58, baseline=-0.5ex, xshift=-8mm]{%
        \def\cell{0.40} % was 0.45
        \tikzset{
        ...
        \foreach \i in {0,1,2}{
          \foreach \j in {0,1,2}{
            \draw (\j*\cell,-\i*\cell) circle(0.03); % smaller dots
          }
        }
        ...
        % -------- MIN (rechts) ----------
        \begin{scope}[shift={(1.6,0)}] % was 2.2 → 2.0 → now 1.6
          \foreach \i in {0,1,2}{
            \foreach \j in {0,1,2}{
