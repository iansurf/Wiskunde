...
\begin{axis}[
  ...
  legend style={
    draw=none, fill=none,
    legend columns=1,
    at={(axis cs:-3.8,2.6)},  % links van de figuur
    anchor=west
  },
...
% labels bij de krommen (zoals in het voorbeeld)
\node[green!60!black] at (axis cs:0.95,1.1) {\small $f$};
\node[red!70!black]   at (axis cs:-0.95,3.1) {\small $g$};
\node[blue!70!black]  at (axis cs:3.7,1.28) {\small $h$};
