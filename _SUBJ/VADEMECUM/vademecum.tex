...
% ----------------- Arrows -----------------
\draw[->, thick] (box1.south) .. controls +(0,-1) and +(0,1) .. (box3.north)node[midway, left] {$\scriptstyle \mathrm{RREF}$};
\draw[->, thick] (box1.south east) .. controls +(1,-1) and +(-1,1) .. (box4.north west)node[midway, right] {$\scriptstyle \mathrm{RREF}$};
