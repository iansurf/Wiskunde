...
% ----------------- Second row (copy) -----------------
\node (box3) [draw, inner sep=2pt, minimum width=6cm, below=1cm of box1] {
  \begin{minipage}{0.47\linewidth}
  \[
  \begin{array}{c}
  \begin{bmatrix}
...
% ----------------- Arrows -----------------
\draw[->, thick] (box1.south) .. controls +(0,-1) and +(0,1) .. (box3.north)node[midway, left] {$\scriptstyle \mathrm{RREF} (samenvallend)$};
\draw[->, thick] (box1.south east) .. controls +(1,-1) and +(-1,1) .. (box4.north west)node[midway, right] {$\scriptstyle \mathrm{RREF} (snijdend)$};
