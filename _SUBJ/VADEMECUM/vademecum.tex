...
\textbf{Parallel, verschillend}\\[2mm]
...
% ----------------- First row -----------------
\node (box1) [draw, inner sep=1pt, minimum width=7cm, anchor=north west] at (0,0) {
  \begin{minipage}{0.4\linewidth}
  \[
  \begin{array}{c @{\qquad} c}
  \alpha_0 \cap \beta_0 = \Box_0 &
  \begin{bmatrix}
...
\node (box2) [draw, inner sep=1pt, minimum width=7cm, anchor=north west] at (7,0) {
  \begin{minipage}{0.4\linewidth}
  \[
  \begin{array}{c @{\qquad} c}
  \alpha \cap \beta = \Box &
...
% ----------------- Second row (copy) -----------------
\node (box3) [draw, inner sep=2pt, minimum width=6cm, below=2.5cm of box1] {
...
\node (box4) [draw, inner sep=2pt, minimum width=6cm, below=2.5cm of box2] {
  \begin{minipage}{0.47\linewidth}
  \[
  \begin{array}{c @{\qquad} c}
  \alpha_0 \cap \beta_0 = \Box_0 &
...
% ----------------- Arrows -----------------
\draw[->, thick] (box1.south) .. controls +(0,-1) and +(0,1) .. (box3.north)node[midway, left] {$\;\;$RREF};
\draw[->, thick] (box1.south east) .. controls +(1,-1) and +(-1,1) .. (box4.north west)node[midway, left] {$\;\;$RREF};
