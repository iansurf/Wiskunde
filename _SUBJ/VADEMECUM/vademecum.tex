...
\end{center}
% ----------------------------------------------------------------------------- 
% --- Determinanten (2x groter diagram, verder naar links) --------------------
...
\node (box1) [draw, inner sep=2pt, minimum width=10cm] at (0,0) {%
  ...
  % compacter kolom-interval dan \qquad
  \[
  ...
  \begin{array}{c @{\hspace{4pt}} c}
    ...
    {\displaystyle
      ...
      \mathrel{\smash{\xrightarrow{\scriptstyle\text{Sarrus}}}}\;
      % ---- inline mini-TikZ (2x groter, verder links) ----
      \tikz[scale=2, baseline=-5ex, xshift=-3cm]{%
        ...
        % -------- MIN (rechts) ----------
        \begin{scope}[shift={(0,0)}] % dichter bij het plus-blok
          \foreach \i in {0,1,2}{
            \foreach \j in {0,1,2}{
              \draw (\j*\cell,-\i*\cell) circle(0.03);
            }
